"""
Django settings for KnowledgeManagerSystem project.
...
ROOT_URLCONF = 'KnowledgeManagerSystem.urls'
...
WSGI_APPLICATION = 'KnowledgeManagerSystem.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'sadfas.sqlite3'),
    }
}
