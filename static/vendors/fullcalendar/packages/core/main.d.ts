...
declare module '@fullcalendar/core' {
	...
	export {
		DateMarker, addDays, startOfDay, addMs, addWeeks, diffWeeks, diffWholeWeeks, diffWholeDays, diffDayAndTime, diffDays, isValidDate
	} from '@fullcalendar/core/datelib/marker';
	export {
		Duration, createDuration, isSingleDay, multiplyDuration, addDurations, asRoughMinutes, asRoughSeconds, asRoughMs, wholeDivideDurations, greatestDurationDenominator
	...
	export {
		EventRenderRange, sliceEventStore, hasBgRendering, getElSeg, computeEventDraggable, computeEventStartResizable, computeEventEndResizable
...
declare module '@fullcalendar/core/plugin-system' {
	...
	import Calendar, {CalendarInteractionClass, DatePointTransform, DateSpanTransform, OptionChangeHandlerMap} from '@fullcalendar/core/Calendar';
	...
	import {eventDragMutationMassager, EventDropTransformers, eventIsDraggableTransformer} from '@fullcalendar/core/interactions/event-dragging';
...
declare module '@fullcalendar/core/datelib/formatting-cmd' {
	import {DateFormatter, DateFormattingContext, VerboseFormattingArg, ZonedMarker} from '@fullcalendar/core/datelib/formatting';
