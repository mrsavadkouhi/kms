...
declare module '@fullcalendar/interaction/interactions-external/ExternalElementDragging' {
	import {Calendar, DatePointApi, DragMeta, DragMetaInput, ElementDragging, EventInteractionState, EventTuple, Hit, PointerDragEvent, View} from '@fullcalendar/core';
...
declare module '@fullcalendar/interaction/interactions/HitDragging' {
	import {ElementDragging, EmitterMixin, Hit, InteractionSettingsStore, Point, PointerDragEvent} from '@fullcalendar/core';
