...
declare module '@fullcalendar/list/ListView' {
	import {ComponentContext, DateMarker, DateRange, EventRenderRange, EventStore, EventUiHash, ScrollComponent, Seg, View, ViewProps, ViewSpec} from '@fullcalendar/core';
