...
declare module '@fullcalendar/timegrid/TimeGridView' {
	import {ComponentContext, DateProfile, DateProfileGenerator, DayHeader, DayTable, ViewProps} from '@fullcalendar/core';
...
declare module '@fullcalendar/timegrid/TimeGrid' {
	import {ComponentContext, DateComponent, DateFormatter, DateMarker, DateProfile, Duration, EventSegUiInteractionState, PositionCache, Seg, Theme} from '@fullcalendar/core';
